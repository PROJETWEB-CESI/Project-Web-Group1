...
const translations = {
  en: {
    ...
    myProfileSubtitle: 'Manage your personal information and preferences.',
    ...
    emailNotificationsHint: 'Receive an email for important updates (grades, payments, schedule changes).',
    inAppNotifications: 'In-app notifications',
    inAppNotificationsHint: 'Show notifications in the bell menu.',
    preferencesSaved: 'Preferences saved.',
    displayTheme: 'Theme',
    themeLight: 'Light',
    themeDark: 'Dark',
    themeHighContrast: 'High contrast',
    sessionsTitle: 'Active session',
  ...
  fr: {
    ...
    myProfileSubtitle: 'Gérez vos informations personnelles et préférences.',
    ...
    emailNotificationsHint: 'Recevoir un email pour les mises à jour importantes (notes, paiements, changements d\'emploi du temps).',
    inAppNotifications: 'Notifications dans l\'application',
    inAppNotificationsHint: 'Afficher les notifications dans le menu cloche.',
    preferencesSaved: 'Préférences enregistrées.',
    displayTheme: 'Thème',
    themeLight: 'Clair',
    themeDark: 'Sombre',
    themeHighContrast: 'Contraste élevé',
    sessionsTitle: 'Session active',
