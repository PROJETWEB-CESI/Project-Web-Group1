...
const translations = {
  en: {
    ...
    csvGroupAverage: 'Group average',
    csvColStudents: 'Students',
    csvColCapacity: 'Capacity',
    csvColSuccessRatePct: 'Success rate (%)',
    csvColAverageGrade: 'Average grade',
    csvColAttendanceRatePct: 'Attendance rate (%)',
    csvColDropoutRatePct: 'Dropout rate (%)',
    csvColRevenueCollected: 'Revenue collected (EUR)',
    csvColFillRatePct: 'Fill rate (%)',
    csvColActiveStudents: 'Active students',
    csvColTotalStudents: 'Total students',
    csvColEntriesByYear: 'Active students by entry year',
    csvColOverdueInvoices: 'Overdue invoices',
    csvColOverdueAmount: 'Overdue amount (EUR)',
    // Admin dashboard
  ...
  fr: {
    ...
    csvGroupAverage: 'Moyenne groupe',
    csvColStudents: 'Étudiants',
    csvColCapacity: 'Capacité',
    csvColSuccessRatePct: 'Taux de réussite (%)',
    csvColAverageGrade: 'Moyenne générale',
    csvColAttendanceRatePct: 'Taux de présence (%)',
    csvColDropoutRatePct: "Taux d'abandon (%)",
    csvColRevenueCollected: 'CA encaissé (EUR)',
    csvColFillRatePct: 'Taux de remplissage (%)',
    csvColActiveStudents: 'Étudiants actifs',
    csvColTotalStudents: 'Étudiants au total',
    csvColEntriesByYear: "Étudiants actifs par année d'entrée",
    csvColOverdueInvoices: 'Factures impayées',
    csvColOverdueAmount: 'Montant impayé (EUR)',
    // Admin dashboard
