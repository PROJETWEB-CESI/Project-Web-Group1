...
export default function ScrollShadow({ children, className = '' }) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className="pointer-events-none absolute inset-y-0 left-0 w-[15px] transition-opacity duration-300 ease-in-out"
        style={{
      ...
      />
      <div
        className="pointer-events-none absolute inset-y-0 right-0 w-[15px] transition-opacity duration-300 ease-in-out"
        style={{
